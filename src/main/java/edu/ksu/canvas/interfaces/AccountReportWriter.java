...
public interface AccountReportWriter extends CanvasWriter<AccountReport, AccountReportWriter> {
     ...
     */
    Optional<AccountReport> startReport(AccountReportOptions options) throws IOException, ProtocolException, URISyntaxException;
     ...
     */
    Optional<AccountReport> deleteReport(String accountId, String report, Long reportId) throws IOException, ProtocolException, URISyntaxException;
}
