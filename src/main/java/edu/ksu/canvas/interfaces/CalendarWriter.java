...
public interface CalendarWriter extends CanvasWriter<CalendarEvent, CalendarWriter> {
     ...
     */
    Optional<CalendarEvent> deleteCalendarEvent(DeleteCalendarEventOptions options) throws IOException, ProtocolException, URISyntaxException;
     ...
     * @throws IOException When there is an error communicating with Canvas
     */
    Optional<CalendarEvent> createCalendarEvent(CalendarEvent calendarEvent) throws IOException, ProtocolException, URISyntaxException;
     ...
     * @throws IOException When there is an error communicating with Canvas
     */
    Optional<CalendarEvent> editCalendarEvent(CalendarEvent calendarEvent) throws IOException, ProtocolException, URISyntaxException;
