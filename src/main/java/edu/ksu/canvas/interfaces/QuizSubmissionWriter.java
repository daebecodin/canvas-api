...
public interface QuizSubmissionWriter extends CanvasWriter<QuizSubmission, QuizSubmissionWriter> {
     ...
     */
    Optional<QuizSubmission> startQuizSubmission(StartQuizSubmissionOptions options) throws IOException, ProtocolException, URISyntaxException;
     ...
     * @throws IOException If there is an error talking to Canvas
     */
    Optional<QuizSubmission> completeQuizSubmission(CompleteQuizSubmissionOptions options) throws IOException, ProtocolException, URISyntaxException;
}
