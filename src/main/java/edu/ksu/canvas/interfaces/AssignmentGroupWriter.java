...
public interface AssignmentGroupWriter extends CanvasWriter<AssignmentGroup, AssignmentGroupWriter>{
     ...
     */
    Optional<AssignmentGroup> createAssignmentGroup(String courseId, AssignmentGroup assignmentGroup) throws IOException, ProtocolException, URISyntaxException;
     ...
     * @throws IOException When there is an error communicating with Canvas
     */
    Optional<AssignmentGroup> editAssignmentGroup(String courseId, AssignmentGroup assignmentGroup) throws IOException, ProtocolException, URISyntaxException;
     ...
     * @throws IOException When there is an error communicating with Canvas
     */
    Optional<AssignmentGroup> deleteAssignmentGroup(DeleteAssignmentGroupOptions options) throws IOException, ProtocolException, URISyntaxException;
}
