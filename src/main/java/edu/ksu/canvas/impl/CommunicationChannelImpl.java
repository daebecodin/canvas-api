...
public class CommunicationChannelImpl extends BaseImpl<CommunicationChannel, CommunicationChannelReader, CommunicationChannelWriter> implements CommunicationChannelReader, CommunicationChannelWriter {
    ...
    @Override
    public Optional<CommunicationChannel> createCommunicationChannel(CreateCommunicationChannelOptions options) throws IOException, ProtocolException, URISyntaxException {
    ...
    @Override
    public Optional<CommunicationChannel> deleteCommunicationChannel(CommunicationChannel cc) throws IOException, ProtocolException, URISyntaxException {
